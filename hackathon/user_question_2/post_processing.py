...
for i, event_name in enumerate(event_names):
    ...
    # Column mapping
    column_mapping_overlay = {event_wl_column: f"{event_name}_" + aggregate_wl_column,
...
redundancy_result_gdf.to_file('/output/overlay_result.geojson', driver="GeoJSON")
redundancy_result_gdf.to_feather('/output/overlay_result.feather')