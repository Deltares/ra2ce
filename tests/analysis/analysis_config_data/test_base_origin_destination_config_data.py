...
class TestOriginDestinationConfigData:
    def test_initialization(
        self, origin_destination_config_data_type: type[BaseOriginDestinationConfigData]
    ) -> None:
        # 1. Define test data.
        ...
        assert isinstance(
            _origin_destination_config_data, BaseOriginDestinationConfigData
        )
        ...
        assert (
            _origin_destination_config_data.calculate_route_without_disruption is False
        )
