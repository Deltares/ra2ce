...
_unsupported_damages_analysis = [
    AnalysisDamagesEnum.EFFECTIVENESS_MEASURES,
    AnalysisDamagesEnum.INVALID,
]
_unsupported_losses_analysis = [AnalysisLossesEnum.INVALID]
...
class TestAnalysisCollection:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            if _analysis_type not in _unsupported_damages_analysis
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            if _analysis_type not in _unsupported_losses_analysis
        ],
    )
