...
class TestVectorNetworkWrapper:
    ...
    def test_initialize(self):
        ...
        _config_data.network.primary_files = [Path("dummy_primary")]
        ...
        assert _wrapper.primary_files == _config_data.network.primary_files
    ...
    def _valid_wrapper(self, request: pytest.FixtureRequest) -> VectorNetworkWrapper:
        ...
        _config_data = NetworkConfigData()
        _config_data.network.primary_files = [
