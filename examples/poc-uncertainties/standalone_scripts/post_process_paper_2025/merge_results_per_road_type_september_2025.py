...
df_primary.to_csv(result_csv.parent.joinpath('primary.csv'), index=False)
df_secondary.to_csv(result_csv.parent.joinpath('secondary.csv'), index=False)
df_tertiary.to_csv(result_csv.parent.joinpath('tertiary.csv'), index=False)
df_highway.to_csv(result_csv.parent.joinpath('highway.csv'), index=False)
