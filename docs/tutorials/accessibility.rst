...
👉 See the detailed tutorial: :doc:`Defined Origin–Destination Pairs <accessibility.all_origin_destinations>`
...
.. toctree::
   ...
   accessibility.all_origin_destinations
   accessibility.closest_origin_destinations
